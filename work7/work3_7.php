<?php
// 1. Front Controller в проекте architecture это MainController.php который может перенаправить запрос в зависимости от входящих данных
// 2. В проекте architecture Registry больше всего напоминает папка architecture/src/Model/Repository/ в ней содержатся коллекция уже полученных обьектов 
