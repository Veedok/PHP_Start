<?php
// Код взял с https://habr.com/ru/post/263775/
// Пока на 100% всю статью не осилил но буду пытаться дальше. Понял как берется выражение как оно затем делиться и приабразовывается в массив
// так же понял что после мы строим обьекты на основе массива. Вот дальше пока не понятно но буду ковырять как именно мы строим тройки.
//  так то по уроку принцип их построения с одними цифрами намного легче. Сейчас мозги кипят но продолжу дальше ковырять
class Main {
    var $arNode = Array();
